...
<html lang="en">
  <head>
    ...
    <title>View Doctor Prescription</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Patient Prescription </h3>
...
PreparedStatement pstmt = con.prepareStatement("select * from prescription_image where patient_id=?");
...
<tr>
<td><%= rs.getInt(2) %></td>
<td><a href="viewImage.jsp?id=<%= patient_id%>"><b><font color="green">View Prescription</font></b></a></td>
<%
}
%>
</tr>
