            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="view_patient_to_av.jsp">View case</a></li>
                 </ul>
              </div>
            </li>
            <li class="nav-item nav-category"><span class="nav-link">Arogya Vibhag</span></li>
...
PreparedStatement pstmt2 = con.prepareStatement("select image from prescription_image where patient_id=?");
pstmt2.setInt(1, patient_id);
ResultSet rs2 = pstmt2.executeQuery();
if(rs2.next())
{
%>
    <td><a href="viewImage.jsp?id=<%=rs.getInt(1)%>"><button type="submit" class="btn btn-success btn-rounded btn-fw">View Prescription</button></a></td>
<%
}
else
{
