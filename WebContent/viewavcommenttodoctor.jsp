...
<html lang="en">
  <head>
    ...
    <title>View Arogya Vibhag comments</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Arogya Vibhag Comments </h3>
...
PreparedStatement pstmt = con.prepareStatement("select * from av_comments where patient_id=?");
pstmt.setInt(1, patient_id);
ResultSet rs = pstmt.executeQuery();
/*PreparedStatement pstmt1 = con.prepareStatement("select name from patient where patient_id=?");
