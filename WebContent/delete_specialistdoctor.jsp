        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Specialist Doctors </h3>
...
PreparedStatement pstmt = con.prepareStatement("select * from specialist_doctor");
...
<td><a href="DeleteSpecialistDoctorServlet?id=<%=rs.getInt(1)%>"><button type="submit" class="btn btn-danger btn-rounded btn-fw">delete</button></a></td>
</tr>
<%
}
}
