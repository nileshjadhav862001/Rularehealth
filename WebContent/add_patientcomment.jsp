...
<html lang="en">
  <head>
    ...
    <title>Add Patient Comment</title>
    <!-- plugins:css -->
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="add_patientcomment.jsp">Add comment</a></li>
                  </ul>
              </div>
            </li>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Add Patient Comment </h3>
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <form class="forms-sample" action="AddDoctorCommentServlet">
                    <%
                      int patient_id = Integer.parseInt(request.getParameter("id"));
                      AccountCredentials.setPatient_id((patient_id));
                      Connection con = DbConnection.connect();
                      PreparedStatement pstmt = con.prepareStatement("select disease_name,av_id from patient where patient_id=?");
                      pstmt.setInt(1, patient_id);
                      System.out.println(patient_id);
                      ResultSet rs = pstmt.executeQuery();
                      if(rs.next())
                      {
                    	  AccountCredentials.setDisease(rs.getString(1));
                    	  AccountCredentials.setAv_id(rs.getInt(2));
                      }
                      
                      %>
                      <div class="form-group">
                        <label for="exampleTextarea1">Add Patient Comment</label>
                        <textarea class="form-control" name="comment" placeholder="write comment here..." id="exampleTextarea1" rows="6"></textarea>
                      </div>
                      <br>
                      <br>
                      
                      <button type="submit" class="btn btn-primary mr-2">Submit</button>
                      <button class="btn btn-light" action="view_doctorpatientcase.jsp">Cancel</button> 
                    </form>
                  </div>
                </div>
              </div>
