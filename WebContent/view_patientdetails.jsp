...
while(rs.next())
{
	...
	%>
	  <td><a href="viewdoctorcommenttodoctor.jsp?id=<%=rs.getInt(1)%>"><b><font color="green">View Doctor Comment</font></b></a></td>
	<%
	}
	else
	{
	...
	if(rs2.next())
	{
		AccountCredentials.setPatient_name(rs.getString(2));
	%>
	  <td><a href="viewavcommenttodoctor.jsp?id=<%=rs.getInt(1)%>"><b><font color="green">View AV Comment</font></b></a></td>
	<%
	}
	else
	{
